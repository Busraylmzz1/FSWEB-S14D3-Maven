...
public class CarSkeleton {
    ...
    if (carSkeleton instanceof  ElectricCar){
       ...
       System.out.println("The car engine is starting with hybrid. Per charge:" + hybridCar.getAvgKmPerLiter() + "battery size:" +hybridCar.getBatterySize()+ hybridCar.getCylinders());
